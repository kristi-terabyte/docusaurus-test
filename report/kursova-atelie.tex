...
\usepackage{tikz}
\usetikzlibrary{arrows.meta,positioning,shapes.geometric,shapes.misc,shapes.symbols,fit,backgrounds}
...
\tikzset{
  ...
  entity/.style={draw,rectangle,fill=yellow!10,rounded corners,align=left},
